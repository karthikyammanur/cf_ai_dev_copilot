...
const DOCS_KNOWLEDGE_BASE: DocEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    category: "storage",
    explanation:
      "Workers KV is a global, low-latency key-value data store. It is eventually consistent and best suited for read-heavy workloads like configuration, cached data, and session storage.",
    keywords: [
      "kv",
      "key-value",
      "storage",
...
export default {
...

  {
    ...
    category: "storage",
    explanation:
      "D1 is Cloudflare's native serverless SQL database built on SQLite. It provides relational data storage with ACID transactions and is ideal for structured data and complex queries.",
    keywords: [
      "d1",
      "database",
      "sql",
...
export default {
...

  {
    ...
    category: "storage",
    explanation:
      "R2 is Cloudflare's object storage with zero egress fees. It's perfect for storing large files, images, videos, and backups with S3-compatible APIs.",
    keywords: [
      "r2",
      "object storage",
      "bucket",
...
export default {
...

  {
    ...
    category: "storage",
    explanation:
      "Durable Objects provide low-latency coordination and consistent storage for applications that require real-time collaboration, WebSockets, or strong consistency guarantees.",
    keywords: [
      "durable objects",
      "stateful",
      "websocket",
...
export default {
  ...
  // -------------------------------------------------------------------------
  {
    ...
    category: "ai",
    explanation:
      "Workers AI provides access to AI models like LLMs (Llama), embeddings, image generation, and more, running directly on Cloudflare's network with no cold starts.",
    keywords: [
      "ai",
      "llm",
      "llama",
...
export default {
...

  {
    ...
    category: "compute",
    explanation:
      "Cloudflare Queues enables asynchronous message processing for background tasks, batching operations, and decoupling services with guaranteed delivery.",
    keywords: [
      "queues",
      "queue",
      "background",
...
export default {
  ...
  // -------------------------------------------------------------------------
  {
    ...
    category: "network",
    explanation:
      "The Fetch API in Workers allows making HTTP requests to external services. Workers automatically optimize requests using Cloudflare's global network.",
    keywords: [
      "fetch",
      "http",
      "request",
...

  {
    ...
    category: "network",
    explanation:
      "The Cache API allows you to control caching behavior at the edge, storing and retrieving responses to reduce latency and origin load.",
    keywords: [
      "cache",
      "caching",
      "cdn",
...
async function cacheWithTTL(request, ttl = 300) {
...

  {
    ...
    category: "network",
    explanation:
      "Workers support WebSockets for bi-directional, real-time communication. Combine with Durable Objects for stateful WebSocket applications like chat or multiplayer games.",
    keywords: [
      "websocket",
      "websockets",
      "ws",
...
export class ChatRoom extends DurableObject {
  ...
  // -------------------------------------------------------------------------
  {
    ...
    explanation:
      "Bindings allow Workers to interact with Cloudflare resources like KV, D1, R2, and services. They're configured in wrangler.toml and accessed via the env parameter.",
    keywords: [
      "bindings",
      "binding",
      "environment",
...
export default {
...

  {
    ...
    category: "developer-platform",
    explanation:
      "Environment variables store configuration, while secrets store sensitive data like API keys. Variables go in wrangler.toml, secrets use wrangler secret command.",
    keywords: [
      "environment",
      "variables",
      "secrets",
...
export default {
...

  {
    ...
    category: "developer-platform",
    explanation:
      "Wrangler is the official CLI for developing, testing, and deploying Cloudflare Workers. It provides commands for local development, deployment, and resource management.",
    keywords: [
      "wrangler",
      "cli",
      "deploy",
...
wrangler deployments list`,
...

  {
    ...
    category: "compute",
    explanation:
      "Cloudflare Workers run JavaScript/TypeScript at the edge on Cloudflare's global network. They handle HTTP requests with minimal latency and can access various storage and compute resources.",
    keywords: [
      "workers",
      "worker",
      "basics",
...
export default {
...

  {
    ...
    category: "network",
    explanation:
      "Workers use standard Web APIs for HTTP requests and responses. The Request object contains incoming request data, while Response constructs the output.",
    keywords: [
      "request",
      "response",
      "headers",
  ...
  // -------------------------------------------------------------------------
  {
    ...
    category: "security",
    explanation:
      "CORS headers allow browsers to access your API from different domains. Workers must explicitly set CORS headers to enable cross-origin requests.",
    keywords: [
      "cors",
      "cross-origin",
      "preflight",
...
function handleCors(request, response, allowedOrigins = ['https://example.com']) {
...

  {
    ...
    category: "security",
    explanation:
      "Rate limiting prevents abuse by restricting the number of requests from a client. Implement using Durable Objects for distributed counters or KV with expiration.",
    keywords: [
      "rate limit",
      "rate limiting",
      "throttle",
...
export default {
  ...
  // -------------------------------------------------------------------------
  {
    ...
    category: "developer-platform",
    explanation:
      "Cloudflare Pages Functions combine static assets with serverless functions. They use file-based routing and run on Workers runtime.",
    keywords: [
      "pages",
      "pages functions",
      "static",
...
export async function onRequest(context) {
...

  {
    ...
    category: "network",
    explanation:
      "Stream data to clients without buffering the entire response in memory. Essential for large files, real-time data, and Server-Sent Events (SSE).",
    keywords: [
      "streaming",
      "stream",
      "transformstream",
...
export default {
...

  {
    ...
    category: "compute",
    explanation:
      "Cron Triggers allow Workers to run on a schedule for periodic tasks like cleanup, reports, or data synchronization.",
    keywords: [
      "cron",
      "scheduled",
      "schedule",
...
export default {
...

  {
    ...
    category: "ai",
    explanation:
      "Vectorize is Cloudflare's vector database for storing and querying embeddings, enabling semantic search, recommendations, and RAG applications.",
    keywords: [
      "vectorize",
      "vector",
      "embeddings",
...
export default {
...

  {
    ...
    category: "developer-platform",
    explanation:
      "Proper error handling ensures Workers respond gracefully to failures, log useful debugging information, and provide meaningful error responses.",
    keywords: [
      "error",
      "errors",
      "exception",
...
class APIError extends Error {
...

  {
    ...
    category: "developer-platform",
    explanation:
      "Workers support console logging for debugging. Use wrangler tail for real-time logs, or configure Logpush for production log aggregation.",
    keywords: [
      "logging",
      "logs",
      "console",
...
class Logger {
...

  {
    ...
    category: "developer-platform",
    explanation:
      "Test Workers locally using Vitest and @cloudflare/vitest-pool-workers. Write unit and integration tests with access to bindings.",
    keywords: [
      "testing",
      "tests",
      "vitest",
 ...
 */
export function searchDocumentationFn(
  query: string,
  maxResults: number = 3
): SearchDocsResponse {
...
const searchCloudflareDocsSchema = z.object({
  ...
  maxResults: z
    ...
    .optional()
    .default(3)
    .describe("Maximum number of results to return (1-5). Default is 3.")
});
